...
const jadibot = async (Zeltoria, m, from) => {
...
auth: state,
browser: [`Jadibot Md By (Rainchy)`, "Chrome", "1.0.0"],
...
await Zeltoria.sendMessage(callerId, { text: `Sistem Otomatis Block!!!\nJangan Menelpon Bot!!!\nSilahkan Hubungi Owner Untuk Dibuka!!!`}, { quoted : qutsnya })
await sleep(8000)
...
await m.reply(`*Connected to Whatsapp - Bot*\n\n*User :*\n _*× id : ${Zeltoria.decodeJid(Zeltoria.user.id)}*_`)
...
console.log(`Bad Session File, Please Delete Session and Scan Again`); Zeltoria.logout(); }
...
console.log("Connection Replaced, Another New Session Opened, Please Close Current Session First"); Zeltoria.logout(); }
else if (reason === DisconnectReason.loggedOut) { 
console.log(`Device Logged Out, Please Scan Again And Run.`); Zeltoria.logout(); }
